...
class QCSSelectDlgButtonsWidget : public QWidget
{
    Q_OBJECT
public:
    explicit QCSSelectDlgButtonsWidget(QString strTableName , QString strColName , bool bChekable , QString strСondition = " ", bool bMultiselect = false , QWidget *parent = nullptr);
    bool m_bMultiSelect;
