#ifndef QREGISTERPARTNERWashDLG_H
#define QREGISTERPARTNERWashDLG_H
...
class QRegisterPartnerWashDlg : public QCSBaseDialog
{
    Q_OBJECT
public:
    QRegisterPartnerWashDlg(QWidget *parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
...
#endif // QREGISTERPARTNERWashDLG_H
