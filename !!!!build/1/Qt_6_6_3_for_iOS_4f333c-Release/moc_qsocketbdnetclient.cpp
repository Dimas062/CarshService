...
Q_CONSTINIT static const qt_meta_stringdata_CLASSQSocketBDNetClientENDCLASS_t qt_meta_stringdata_CLASSQSocketBDNetClientENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(43, 9),  // "writeData"
        QT_MOC_LITERAL(53, 4),  // "data"
        QT_MOC_LITERAL(58, 13)   // "connectToHost"
    },
    "QSocketBDNetClient",
    "dataReceived",
    "",
...
void QSocketBDNetClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { bool _r = _t->writeData((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 3: { bool _r = _t->connectToHost();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
